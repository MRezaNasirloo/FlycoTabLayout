...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setIndicatorBorderColor(int indicatorBorderColor) {
        this.mIndicatorStrokeColor = indicatorBorderColor;
        invalidate();
    }

    public void setIndicatorBorderSize(int indicatorBorderSize) {
        this.mIndicatorStrokeWidth = indicatorBorderSize;
        invalidate();
    }
